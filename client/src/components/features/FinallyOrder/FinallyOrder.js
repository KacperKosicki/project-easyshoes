          ...
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className={`modal-header ${styles.customHeader}`}>
                ...
                <button type="button" className={`close ${styles.customClose}`} onClick={handleModalClose} aria-label="Close">
              ...
              <div className="modal-footer">
                ...
                <button type="button" className="btn btn-success" onClick={sendOrderToServer}>Złóż zamówienie</button>
              </div>
            </div>
          </div>
        </div>
